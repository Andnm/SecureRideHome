...
export const CardAccountInfo = ({
  ...
  const statusColor = getStatusColor(dataStudent.relationship_status);
            ...
            <div className="relative mt-16 max-w-sm mx-auto ">
              <div className="rounded overflow-hidden shadow-md bg-white">
                ...
                <div className="px-6 mt-16 mb-5">
                  ...
                  <div className="flex text-center text-gray-600 text-base pt-3 font-normal gap-3 justify-between">
                    <p className="text-gray-800 text-sm text-center">
                      Trạng thái tham gia:
                    </p>
                    <p className={`text-sm ${statusColor}`}>
                      {dataStudent.relationship_status === "Pending" &&
                        "Đang chờ xác nhận"}
                      {dataStudent.relationship_status === "Joined" &&
                        "Đã tham gia"}
                      {dataStudent.relationship_status === "Rejected" &&
                        "Đã từ chối"}
                    </p>
                  </div>
                </div>
